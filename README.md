...
- **[reidliu41](https://github.com/reidliu41)** — resume hint, workspace trust persistence, Ollama provider support, thinking-block stream finalization, CI cache hardening, streaming wrap, DeepSeek model completions, help picker selection polish, and user-message transcript highlight (#863, #870, #921, #1078, #1603, #1628, #1601, #1964, #1995)
...
- **[zlh124](https://github.com/zlh124)** — WSL2/headless startup report, clipboard-init fix, and `SKILL.md` YAML block-scalar parser (#1772, #1773, #1908)
...
- **[h3c-hexin](https://github.com/h3c-hexin)** — streaming batch tool-call preservation, CLI reasoning-effort passthrough, and file_search cancellation/stop report (#1686, #1511, #2044)
...
- **[lpeng1711694086-lang](https://github.com/lpeng1711694086-lang)** — user-message TUI contrast feature request (#1672)
